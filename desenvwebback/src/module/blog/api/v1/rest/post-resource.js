...
router.get(process.env.BASE_URL + '/api/v1/rest/post/:id',
    async function (req, resp){
		...
		let Reply = await model.reply.schema('public');

		// da forma mais estupida possivel, pois o findByPk tava dando erro no includes, possivelmente algum erro meu ao ajustar os relacionamentos
        ...
        resp.json({data, replies}).status(200);
});
